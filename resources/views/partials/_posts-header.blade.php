        ...
        <div class="relative lg:inline-flex bg-gray-100 rounded-xl">
            <div x-data="{ show: false }">
                ...
                <div x-show="show" class="absolute z-10 w-full py-2 bg-gray-100 rounded-xl mt-2" style="display: none">
                    <a href="/"
                        class="block text-left px-3 text-sm leading-6 hover:bg-blue-500 hover:text-white focus:bg-blue-500 focus:text-white">All
                    </a>
                    @foreach ($categories as $category)
                        <a href="/categories/{{ $category->slug }}"
                            ...
                            {{ isset($currentCategory) && $currentCategory->slug === $category->slug ? 'bg-blue-500 text-white' : '' }}">
